  ...
  return (
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
        ...
        <motion.div className='flex flex-col sm:flex-row items-center 
            ...
            items-center gap-2 rounded-full outline-none focus:scale-110
            hover:scale-110 cursor-pointer active:scale-105 transition border border-black/10'
            ...
            hover:scale-[1.15] hover:text-gray-950 cursor-pointer active:scale-105 transition border border-black/10'
