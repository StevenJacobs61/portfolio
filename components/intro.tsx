  ...
  return (
    ...
    >
      ...
      >
        ...
        working in <span className="underline">process optimisation</span>,
        having delivered solutions to large clients such as{" "}
        <span className="font-bold">Soho House</span>,{" "}
        <span className="font-bold">Deliveroo</span> &{" "}
        <span className="font-bold">Epic Games</span>. I enjoy building{" "}
        <span className="italic">apps & programs</span>. My focus is{" "}
        <span className="underline">React, Node.js & Java</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          className="group bg-white flex px-7 py-3 
            items-center gap-2 rounded-full outline-none focus:scale-110
        ...
        <a
          className="bg-white flex p-4 text-gray-700
